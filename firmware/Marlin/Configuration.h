...
#define STRING_CONFIG_H_AUTHOR "(John Owen)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FrankenMaker v1.3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.8, 78.8, 397, 138.81 }
